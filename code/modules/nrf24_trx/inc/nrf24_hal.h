...
/*the following bitmask value is defined such that it is bit value in the SETUP register*/
typedef enum
{
...
uint8_t                 nrf24_read_multibyte_register(uint8_t reg, uint8_t* buffer, uint8_t len_to_read);
uint8_t                 nrf24_write_register(uint8_t reg, uint8_t value);
uint8_t                 nrf24_write_multibyte_register(uint8_t reg, const uint8_t* buffer, uint8_t len_to_write);
